        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
              Let's find your <br />
              dream <span className="text-blue-600">job</span> with{" "}
              <span className="text-blue-600">Jobsy</span>
            </h2>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-gray-500">Applied AI Scientist</p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-gray-500">Android Developer</p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-gray-500">CUDA Developer</p>
          </div>
        </div>
      </div>
